...
def main():
    ...
    for generation in range(generations):
        if generation==0:
            ...
            co_ordinates_dict,rect_co_ordinates_dict,extra_co_ordinates_dict=co_ordinates_initialize_dict(env_width,env_height,population,size_parameter)
            ...
            for i in range(population):
                ...
                extra_co_ordinates_list=extra_co_ordinates_dict['player'+str(i)]
                ...
                players_dict['player'+str(i)]=player(co_ordinates_list,unused_brain.genes_list,unused_brain,pygame_object,direction,co_ordinates_history_list,rect_co_ordinates_list,extra_co_ordinates_list)
        ...
        for step in range(steps_per_gen):
            ...
            #         print(f'player{i} co_ordiantes history:',players_dict['player'+str(i)].co_ordinates_history_list)
            #         print(f'player{i} rect co_ordiantes:',players_dict['player'+str(i)].rect_co_ordinates_list)
            # for i in range(len(list(players_dict.keys()))):
                # if step%2==0:
            ...
            pygame.image.save(screen, rf'D:\New_Evolution_testing_new_12_genome_length_images\generation{generation+1}\image{step+generation*steps_per_gen+1}.png')
        ...
        for i in range(len(remaining_players_list)):
            dicti[f'player{i}'] = players_dict[remaining_players_list[i]].genes_list
            another_dicti[f'player{i}']=players_dict[remaining_players_list[i]].brain.genes_hexa_list
